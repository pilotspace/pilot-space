...
Plans:
- [x] 43-01-PLAN.md — TypeScript/JS language config, diagnostics types and theme colors, useTypeScriptDefaults + useDiagnostics hooks
- [x] 43-02-PLAN.md — DiagnosticsPanel and DiagnosticRow components, EditorLayout integration
