...
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------ | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `backend/alembic/versions/070_ai_config_custom_provider.py`                  | Migration adding kimi/glm/custom enum + base_url/display_name            | VERIFIED | `down_revision = "069_add_operation_type_to_costs"`; correct upgrade/downgrade; 65 lines                                                                                    |
