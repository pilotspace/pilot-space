...
- [ ] **PPTX-01**: User can view PPTX slides one at a time with prev/next navigation and "Slide N of M" counter
...
- [ ] **PPTX-04**: User can enter fullscreen slideshow mode with keyboard navigation (arrow keys)
