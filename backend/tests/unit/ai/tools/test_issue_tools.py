"""Unit tests for issue MCP tools (T010).

Tests for 10 issue tools: 4 CRUD (IS-001 to IS-004) in issue_server and
6 relationship (IS-005 to IS-010) in issue_relation_server. Uses mock-based
patterns with _capture_tools to intercept SDK tool closures.
